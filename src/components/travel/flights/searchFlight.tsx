...
export default function SearchFlight() {
  ...
  return (
    <div className="flex w-full flex-col items-center justify-center p-0">
      <h2 className="mb-6 text-center font-prompt text-2xl font-extrabold text-[#363C41] lg:mb-4">
      ...
      <div className="relative flex w-full max-w-5xl flex-col items-center rounded-2xl border border-[#E2E2E2] p-20">
        ...
        <button
          ...
          className="absolute bottom-[-20px] left-1/2 flex -translate-x-1/2 transform cursor-pointer items-center justify-center gap-10 rounded-full border-none bg-[#9B297D] px-[24px] py-[16px] font-montserrat text-base font-medium text-white"
        >
          Explore
