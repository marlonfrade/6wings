      ...
      <div className="relative mx-auto flex w-full max-w-xl flex-col items-start gap-2">
        <div className="relative mx-auto w-full max-w-xl">
          <Textarea
            ...
            className={cn(
              'w-full max-w-xl rounded-3xl bg-black/5 py-4 pl-6 pr-10 dark:bg-white/5',
              'placeholder:text-black/70 dark:placeholder:text-white/70',
              'border-none ring-black/30 dark:ring-white/30',
              'resize-none text-wrap leading-[1.2] text-black dark:text-white',
              `min-h-[${minHeight}px]`
            )}
            ref={textareaRef}
            value={inputValue}
          ...
          <button
            ...
            className={cn(
              'absolute right-3 top-1/2 -translate-y-1/2 rounded-xl px-1 py-1',
